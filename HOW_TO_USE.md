# How to Use This Anniversary Website

## Simple 3-Step Process

### Step 1: Upload Your Content
1. Open your deployed website
2. Click the **"Edit Our Story ✨"** button (bottom right corner)
3. Upload photos and videos in each section
...
Your partner doesn't need to do anything except click the link. They'll see:
- All your photos
- All your videos
- All your personalized messages
- The beautiful animations and design

## Tips

- **Compress your images**: Keep them under 2MB each for best results
- **Compress your videos**: Keep them under 5MB each
- **Test the link**: Click it yourself first to make sure everything looks good
- **Update anytime**: Make changes and generate a new link to send

## File Size Recommendations

| Content Type | Recommended Size | Maximum Size |
|--------------|------------------|--------------|
| Images       | 500KB - 1MB      | 10MB         |
| Videos       | 2MB - 3MB        | 10MB         |
| Audio        | 2MB - 3MB        | 10MB         |

Use online tools like TinyPNG (for images) or HandBrake (for videos) to compress your files.
...
Check the README.md file for more technical details.
